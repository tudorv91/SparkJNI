...
CPPPairHmmBean::CPPPairHmmBean(jclass replaceMeClassName, jobject replaceMeObjectName, JNIEnv* env){
	...
	jfieldID j_workload = env->GetFieldID(replaceMeClassName, "workload", "Lorg/tudelft/ewi/ceng/examples/pairHMM/WorkloadPairHmmBean;");
		if(j_workload == NULL){
...
jobject workload_obj = env->GetObjectField(replaceMeObjectName, j_workload);
	...
	jfieldID j_byteArrBean = env->GetFieldID(replaceMeClassName, "byteArrBean", "Lorg/tudelft/ewi/ceng/examples/pairHMM/ByteArrBean;");
...
CPPPairHmmBean::CPPPairHmmBean(double memcopyTimearg, CPPWorkloadPairHmmBean* workloadarg, CPPByteArrBean* byteArrBeanarg, jclass jClass, JNIEnv* jniEnv){
	...
	jmethodID constructor = env->GetMethodID(jClass, "<init>", "(Lorg/tudelft/ewi/ceng/examples/pairHMM/WorkloadPairHmmBean;Lorg/tudelft/ewi/ceng/examples/pairHMM/ByteArrBean;D)V");
	if(constructor == NULL){
