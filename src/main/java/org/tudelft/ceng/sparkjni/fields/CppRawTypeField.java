 ...
 */
package org.tudelft.ceng.sparkjni.fields;//package org.apache.spark.examples;
...
//            nativeTargetType = annotationTargetType;
        ...
        if(nativeTargetType == null)
            ...
            fieldDeclaration = String.format(CppSyntax.FIELD_DECLARATION_STR, nativeTargetType, "%s"+name);
        }
