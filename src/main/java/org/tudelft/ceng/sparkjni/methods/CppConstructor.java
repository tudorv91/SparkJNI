 ...
 */
package org.tudelft.ceng.sparkjni.methods;
...
import org.tudelft.ceng.sparkjni.fields.CppRawTypeField;
import org.tudelft.ceng.sparkjni.utils.CppSyntax;
...
import org.tudelft.ceng.sparkjni.fields.CppReferenceField;
            ...
            for (int aIdx = 0; aIdx < paramAnnotations[idx].length; aIdx++) {
                if (paramAnnotations[idx][aIdx].annotationType().equals(JNI_param.class)) {
                    ...
                    if(paramFieldTarget.equals(CppSyntax.CONSTRUCTOR_PARAM_DEFAULT_NAME_MAPPING)){
                        ...
                        fieldsParamsMap.put(paramFieldTarget, new CppBean(paramTypes[idx]).getCppClassName());
                }
            }
        }
