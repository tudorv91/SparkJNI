...
import org.tudelft.ceng.sparkjni.methods.*;
...
public class CppBean {
    ...
    public CppBean(Class javaClass) {
        this(javaClass, "CPP" + javaClass.getSimpleName());
    }

    public CppBean(Class javaClass, String cppClassName) {
    ...
    public static void setNativeLibPath(String nativeLibPath){
        CppBean.nativeLibPath = nativeLibPath;
    }
