...
import org.heterojni.sparkjni.utils.DeployMode;
...
import static org.heterojni.sparkjni.utils.DeployMode.DeployModes.JUST_BUILD;
...
public class SparkJNIPi {
    ...
    private static String initSparkJni(String[] args) {
        slices = args.length > 0 ? Integer.parseInt(args[0]) : 16;
        sliceSize = args.length > 1 ? Integer.parseInt(args[1]) : 10000000;
        noExecs = args.length > 2 ? Integer.parseInt(args[2]) : 4;
