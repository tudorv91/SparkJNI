...
import org.heterojni.sparkjni.jniFunctions.JniFunction;
import org.heterojni.sparkjni.jniLink.linkContainers.JniMetaContainer;
...
public class JniLinkHandler {
    ...
    private JniMetaContainer jniMetaContainer;
    ...
    public KernelFileWrapperHeader getKernelFile() {
        List<JniHeaderHandler> headers = getJniHeaderHandlersList();
        String targetKernelFilePath = String.format("%s/%s.cpp",
                MetadataHandler.getHandler().getNativePath(),
                MetadataHandler.getHandler().getAppName());
        return new KernelFileWrapperHeader(targetKernelFilePath, jniHeaderFiles, containerHeaderFiles, headers);
    }

    public List<JniHeaderHandler> getJniHeaderHandlersList(){
        JniDirAccessor jniDirAccessor = new JniDirAccessor(MetadataHandler.getHandler().getNativePath());
        return jniDirAccessor.getJniHeaderHandlers();
    }
    ...
    public JniMetaContainer getJniMetaContainer() {
        return jniMetaContainer;
    }

    public void setJniMetaContainer(JniMetaContainer jniMetaContainer) {
        this.jniMetaContainer = jniMetaContainer;
    }
}
