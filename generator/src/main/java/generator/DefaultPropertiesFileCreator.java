...
public class DefaultPropertiesFileCreator {
    public static final String PROPERTY_FILE_COMMENTS = "SparkJNI default properties file: Change properties if needed.\n" +
    ...
    private String OVERWRITE_KERNEL = "OVERWRITE_KERNEL";
    ...
    private void writeDefaultPropertiesFile(FileOutputStream propertiesFileOutputStream) throws IOException {
        ...
        properties.setProperty(APP_NAME, "DEFAULT");
